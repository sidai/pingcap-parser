...
CallStmt:
	"CALL" ProcedureName
	{
		$$ = &ast.CallStmt{ProcedureName: $2.(*ast.ProcedureName), Parameters: []ast.ExprNode{}}
	}
|   "CALL" ProcedureName '(' ExpressionListOpt ')'
	{
		$$ = &ast.CallStmt{ProcedureName: $2.(*ast.ProcedureName), Parameters: $4.([]ast.ExprNode)}
	}

ProcedureName:
	Identifier
	{
		$$ = &ast.ProcedureName{Name: model.NewCIStr($1)}
	}
|	Identifier '.' Identifier
	{
		$$ = &ast.ProcedureName{Schema: model.NewCIStr($1), Name: model.NewCIStr($3)}
	}
